...
<TOCInline 
  toc={[
    ...
    { value: "Cấu hình PHP Application", url: "#cấu-hình-php-application", depth: 2 },
    { value: "Cấu hình MySQL", url: "#cấu-hình-mysql", depth: 2 },
...
Hướng dẫn này sẽ hướng dẫn bạn deploy ứng dụng PHP đơn giản với MySQL database trên Ubuntu server sử dụng Docker và Nginx. Chúng ta sẽ sử dụng ví dụ từ [thư mục examples](/examples/php-simple-app) trong repository này.

<GitHubSourceLink path="examples/php-simple-app" text="📦 Xem source code trên GitHub" />
...
<Image width={1000} height={600} src="/static/images/vps/deploy-php-vps/architecture.svg" alt="Kiến trúc Deployment PHP" />
...
Từ thư mục examples <GitHubSourceLink path="examples/php-simple-app" />, project có cấu trúc:
...
- 📦 [PHP Simple App Example](/examples/php-simple-app) - Source code mẫu
...
1. **Clone example project**: Thử nghiệm với [php-simple-app](/examples/php-simple-app)
...
> [!TIP]
> **Bắt đầu với example**: Sử dụng [php-simple-app](/examples/php-simple-app) như một starting point để hiểu cách setup và customize cho project của bạn!
