...
authors: ["default"]
images: ["/static/images/ddos-attack/thumbnail.png"]
---
...
Gửi một lượng lớn [UDP](/blog/udp) packets đến các cổng ngẫu nhiên của server:
...
**Đặc điểm:**
- Sử dụng [UDP](/blog/udp) (không cần connection)
