...
<TOCInline
	toc={[
		...
		{
			value: "Cách các ứng dụng quản lý độ tin cậy trong UDP",
			url: "#cách-các-ứng-dụng-quản-lý-độ-tin-cậy-trong-udp",
			depth: 2,
		},
...
5. **Dễ bị tấn công**
    - [DDoS attacks](/blog/ddos-attack) dễ dàng hơn (UDP amplification)
...
UDP là một phương thức tấn công phổ biến trong các mối đe dọa [từ chối dịch vụ phân tán (DDoS)](/blog/ddos-attack):
...
- **Firewall rules**: Stateful firewall để theo dõi UDP connections
- **[DDoS protection](/blog/ddos-attack)**: Implement protection chống amplification attacks
